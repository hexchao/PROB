...
for pr_b in Blist:
    ...
    for epoch in range(iteration):
        ...
        if xi == 0:
            ...
            for k in range(B):
                for pi, (para, para0) in enumerate(zip(net[k].parameters(), net0.parameters())):
                    msg[pi][k].data.copy_(10000 * (para.data - para0.data))
    ...
    pr_c = 10 + pr_b
    pd.DataFrame(accuracy_list).to_csv('./result/Acc_BREPFIX{}_N231{}_P{}_M{}_N{}.csv'.format(L_Huber, pr_c, 1 / p, mmm, Node))
