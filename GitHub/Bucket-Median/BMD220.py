    ...
    for pr2 in range(len(xi_w_list)):
        ...
        for pr3 in range(len(BG_list)):
            ...
            for prb in range(4):
                ...
                pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_BMD220%d.csv'%pr_c)
                pd.DataFrame(HS_sum_list).to_csv('/home/hexchao/Simulation_CIFAR10/HSsum_BMD220%d.csv'%pr_c)
                pd.DataFrame(HW_sum_list).to_csv('/home/hexchao/Simulation_CIFAR10/HWsum_BMD220%d.csv'%pr_c)
                pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_BMD220%d.csv'%pr_c)
                pr_c += 1
