...
pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_PROB100%d.csv'%pr_c)
pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_PROB100%d.csv'%pr_c)
pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_PROBHN100%d.csv'%pr_c)
pr_c += 1
