...
for pr_b in range(4):
    ...
    pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_PROB230%d.csv'%pr_c)
    pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_PROB230%d.csv'%pr_c)
    pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_PROB230%d.csv'%pr_c)
    pr_c += 1
