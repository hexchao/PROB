...
for pr_b in range(4):
    ...
    for pr_lc in range(len(lc_list)):
        lc = lc_list[pr_lc]
        iteration = int(30000/lc)
        count_point = 100#画图要多少个点
        count_iter = int(iteration/count_point)#每多少个epoch计算一次acc和H
        ...
        for epoch in range(iteration):
            ...
            for local_epoch in range(lc):
                ...
                for k in range(Node):
                    net[k].fc1.weight.grad += penal * GetSign(net[k].fc1.weight.data.clone(),net0.fc1.weight.data.clone())
                    net[k].fc2.weight.grad += penal * GetSign(net[k].fc2.weight.data.clone(),net0.fc2.weight.data.clone())
                    net[k].fc3.weight.grad += penal * GetSign(net[k].fc3.weight.data.clone(),net0.fc3.weight.data.clone())
                    net[k].conv1.weight.grad += penal * GetSign(net[k].conv1.weight.data.clone(),net0.conv1.weight.data.clone())
                    net[k].conv2.weight.grad += penal * GetSign(net[k].conv2.weight.data.clone(),net0.conv2.weight.data.clone())
                    net[k].fc1.bias.grad += penal * GetSign(net[k].fc1.bias.data.clone(),net0.fc1.bias.data.clone())
                    net[k].fc2.bias.grad += penal * GetSign(net[k].fc2.bias.data.clone(),net0.fc2.bias.data.clone())
                    net[k].fc3.bias.grad += penal * GetSign(net[k].fc3.bias.data.clone(),net0.fc3.bias.data.clone())
                    net[k].conv1.bias.grad += penal * GetSign(net[k].conv1.bias.data.clone(),net0.conv1.bias.data.clone())
                    net[k].conv2.bias.grad += penal * GetSign(net[k].conv2.bias.data.clone(),net0.conv2.bias.data.clone())
                '''
                for k in range(10):
                ...
                for k in range(Node):
                    ...
                    if netk_norm>100:
                        net[k].fc1.weight.data = 100*net[k].fc1.weight.data.clone()/netk_norm
                        net[k].fc2.weight.data = 100*net[k].fc2.weight.data.clone()/netk_norm
                        net[k].fc3.weight.data = 100*net[k].fc3.weight.data.clone()/netk_norm
                        net[k].conv1.weight.data = 100*net[k].conv1.weight.data.clone()/netk_norm
                        net[k].conv2.weight.data = 100*net[k].conv2.weight.data.clone()/netk_norm
                        net[k].fc1.bias.data = 100*net[k].fc1.bias.data.clone()/netk_norm
                        net[k].fc2.bias.data = 100*net[k].fc2.bias.data.clone()/netk_norm
                        net[k].fc3.bias.data = 100*net[k].fc3.bias.data.clone()/netk_norm
                        net[k].conv1.bias.data = 100*net[k].conv1.bias.data.clone()/netk_norm
                        net[k].conv2.bias.data = 100*net[k].conv2.bias.data.clone()/netk_norm

            for k in range(Node):
                sign_fc1_w_0_N[k] = GetSign(net[k].fc1.weight.data.clone(),net0.fc1.weight.data.clone())
                sign_fc2_w_0_N[k] = GetSign(net[k].fc2.weight.data.clone(),net0.fc2.weight.data.clone())
                sign_fc3_w_0_N[k] = GetSign(net[k].fc3.weight.data.clone(),net0.fc3.weight.data.clone())
                sign_conv1_w_0_N[k] = GetSign(net[k].conv1.weight.data.clone(),net0.conv1.weight.data.clone())
                sign_conv2_w_0_N[k] = GetSign(net[k].conv2.weight.data.clone(),net0.conv2.weight.data.clone())
                sign_fc1_b_0_N[k] = GetSign(net[k].fc1.bias.data.clone(),net0.fc1.bias.data.clone())
                sign_fc2_b_0_N[k] = GetSign(net[k].fc2.bias.data.clone(),net0.fc2.bias.data.clone())
                sign_fc3_b_0_N[k] = GetSign(net[k].fc3.bias.data.clone(),net0.fc3.bias.data.clone())
                sign_conv1_b_0_N[k] = GetSign(net[k].conv1.bias.data.clone(),net0.conv1.bias.data.clone())
                sign_conv2_b_0_N[k] = GetSign(net[k].conv2.bias.data.clone(),net0.conv2.bias.data.clone())
            for k in range(Node):
                sign_fc1_w_0_B[k] = GetSign_B(torch.stack([sign_fc1_w_0_N[k] for k in range(10)],2).sum(axis=2),net0.fc1.weight.data.clone())
                sign_fc2_w_0_B[k] = GetSign_B(torch.stack([sign_fc2_w_0_N[k] for k in range(10)],2).sum(axis=2),net0.fc2.weight.data.clone())
                sign_fc3_w_0_B[k] = GetSign_B(torch.stack([sign_fc3_w_0_N[k] for k in range(10)],2).sum(axis=2),net0.fc3.weight.data.clone())
                sign_conv1_w_0_B[k] = GetSign_B(torch.stack([sign_conv1_w_0_N[k] for k in range(10)],4).sum(axis=4),net0.conv1.weight.data.clone())
                sign_conv2_w_0_B[k] = GetSign_B(torch.stack([sign_conv2_w_0_N[k] for k in range(10)],4).sum(axis=4),net0.conv2.weight.data.clone())
                sign_fc1_b_0_B[k] = GetSign_B(torch.stack([sign_fc1_b_0_N[k] for k in range(10)],1).sum(axis=1),net0.fc1.bias.data.clone())
                sign_fc2_b_0_B[k] = GetSign_B(torch.stack([sign_fc2_b_0_N[k] for k in range(10)],1).sum(axis=1),net0.fc2.bias.data.clone())
                sign_fc3_b_0_B[k] = GetSign_B(torch.stack([sign_fc3_b_0_N[k] for k in range(10)],1).sum(axis=1),net0.fc3.bias.data.clone())
                sign_conv1_b_0_B[k] = GetSign_B(torch.stack([sign_conv1_b_0_N[k] for k in range(10)],1).sum(axis=1),net0.conv1.bias.data.clone())
                sign_conv2_b_0_B[k] = GetSign_B(torch.stack([sign_conv2_b_0_N[k] for k in range(10)],1).sum(axis=1),net0.conv2.bias.data.clone())
            net0.fc1.weight.grad = regu * net0.fc1.weight.data.clone() - penal * torch.stack([sign_fc1_w_0_B[k] if k<B else sign_fc1_w_0_N[k] for k in range(10)],2).sum(axis=2)
            net0.fc2.weight.grad = regu * net0.fc2.weight.data.clone() - penal * torch.stack([sign_fc2_w_0_B[k] if k<B else sign_fc2_w_0_N[k] for k in range(10)],2).sum(axis=2)
            net0.fc3.weight.grad = regu * net0.fc3.weight.data.clone() - penal * torch.stack([sign_fc3_w_0_B[k] if k<B else sign_fc3_w_0_N[k] for k in range(10)],2).sum(axis=2)
            net0.conv1.weight.grad = regu * net0.conv1.weight.data.clone() - penal * torch.stack([sign_conv1_w_0_B[k] if k<B else sign_conv1_w_0_N[k] for k in range(10)],4).sum(axis=4)
            net0.conv2.weight.grad = regu * net0.conv2.weight.data.clone() - penal * torch.stack([sign_conv2_w_0_B[k] if k<B else sign_conv2_w_0_N[k] for k in range(10)],4).sum(axis=4)
            net0.fc1.bias.grad = regu * net0.fc1.bias.data.clone() - penal * torch.stack([sign_fc1_b_0_B[k] if k<B else sign_fc1_b_0_N[k] for k in range(10)],1).sum(axis=1)
            net0.fc2.bias.grad = regu * net0.fc2.bias.data.clone() - penal * torch.stack([sign_fc2_b_0_B[k] if k<B else sign_fc2_b_0_N[k] for k in range(10)],1).sum(axis=1)
            net0.fc3.bias.grad = regu * net0.fc3.bias.data.clone() - penal * torch.stack([sign_fc3_b_0_B[k] if k<B else sign_fc3_b_0_N[k] for k in range(10)],1).sum(axis=1)
            net0.conv1.bias.grad = regu * net0.conv1.bias.data.clone() - penal * torch.stack([sign_conv1_b_0_B[k] if k<B else sign_conv1_b_0_N[k] for k in range(10)],1).sum(axis=1)
            net0.conv2.bias.grad = regu * net0.conv2.bias.data.clone() - penal * torch.stack([sign_conv2_b_0_B[k] if k<B else sign_conv2_b_0_N[k] for k in range(10)],1).sum(axis=1)
            optimizer0.step()
            net0_norm = ParaNorm1(net0)
            if net0_norm>100:
                net0.fc1.weight.data = 100*net0.fc1.weight.data.clone()/net0_norm
                net0.fc2.weight.data = 100*net0.fc2.weight.data.clone()/net0_norm
                net0.fc3.weight.data = 100*net0.fc3.weight.data.clone()/net0_norm
                net0.conv1.weight.data = 100*net0.conv1.weight.data.clone()/net0_norm
                net0.conv2.weight.data = 100*net0.conv2.weight.data.clone()/net0_norm
                net0.fc1.bias.data = 100*net0.fc1.bias.data.clone()/net0_norm
                net0.fc2.bias.data = 100*net0.fc2.bias.data.clone()/net0_norm
                net0.fc3.bias.data = 100*net0.fc3.bias.data.clone()/net0_norm
                net0.conv1.bias.data = 100*net0.conv1.bias.data.clone()/net0_norm
                net0.conv2.bias.data = 100*net0.conv2.bias.data.clone()/net0_norm
        ...
        pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_LR240%d.csv'%pr_c)
        pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_LR240%d.csv'%pr_c)
        pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_LR240%d.csv'%pr_c)
        pr_c += 1
