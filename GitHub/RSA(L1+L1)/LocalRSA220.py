    ...
    for pr_lc in range(len(lc_list)):
        ...
        for epoch in range(iteration):
            ...
            for k in range(Node):
                ...
                sign_fc1_w_0_B[k] = GetSign_B(net[k].fc1.weight.data.clone(),net0.fc1.weight.data.clone())
                sign_fc2_w_0_B[k] = GetSign_B(net[k].fc2.weight.data.clone(),net0.fc2.weight.data.clone())
                sign_fc3_w_0_B[k] = GetSign_B(net[k].fc3.weight.data.clone(),net0.fc3.weight.data.clone())
                sign_conv1_w_0_B[k] = GetSign_B(net[k].conv1.weight.data.clone(),net0.conv1.weight.data.clone())
                sign_conv2_w_0_B[k] = GetSign_B(net[k].conv2.weight.data.clone(),net0.conv2.weight.data.clone())
                sign_fc1_b_0_B[k] = GetSign_B(net[k].fc1.bias.data.clone(),net0.fc1.bias.data.clone())
                sign_fc2_b_0_B[k] = GetSign_B(net[k].fc2.bias.data.clone(),net0.fc2.bias.data.clone())
                sign_fc3_b_0_B[k] = GetSign_B(net[k].fc3.bias.data.clone(),net0.fc3.bias.data.clone())
                sign_conv1_b_0_B[k] = GetSign_B(net[k].conv1.bias.data.clone(),net0.conv1.bias.data.clone())
                sign_conv2_b_0_B[k] = GetSign_B(net[k].conv2.bias.data.clone(),net0.conv2.bias.data.clone())
        ...
        pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_LR220%d.csv'%pr_c)
        pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_LR220%d.csv'%pr_c)
        pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_LR220%d.csv'%pr_c)
        pr_c += 1
