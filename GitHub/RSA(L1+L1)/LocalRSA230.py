...
for pr_b in range(4):
    ...
    for pr_lc in range(len(lc_list)):
        ...
        pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_LR230%d.csv'%pr_c)
        pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_LR230%d.csv'%pr_c)
        pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_LR230%d.csv'%pr_c)
        pr_c += 1
