...
for pr1 in range(len(xi_s_list)):
    ...
    for prb in range(4):
        ...
        pd.DataFrame(accuracy_list).to_csv('/home/hexchao/Simulation_CIFAR10/Acc_LL240%d.csv'%pr_c)
        pd.DataFrame(HS_sum_list).to_csv('/home/hexchao/Simulation_CIFAR10/HSsum_LL240%d.csv'%pr_c)
        pd.DataFrame(HW_sum_list).to_csv('/home/hexchao/Simulation_CIFAR10/HWsum_LL240%d.csv'%pr_c)
        pd.DataFrame(loss_list).to_csv('/home/hexchao/Simulation_CIFAR10/Loss_LL240%d.csv'%pr_c)
        pd.DataFrame(dist).to_csv('/home/hexchao/Simulation_CIFAR10/Dist_LL240%d.csv'%pr_c)
        pr_c += 1
